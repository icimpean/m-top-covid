...
class GaussianMixtureBandit(Bandit):
    ...
    def __init__(self, nr_arms, env, t_max, sampling_method: Type[Sampling] = ThompsonSampling,
                 ...
                 variational_max_iter=100, variational_lb_eps=0.001, seed=None, log_dir="./test_results"):
        ...
        # Super call
        super(GaussianMixtureBandit, self).__init__(nr_arms, env, sampling, seed, log_dir)
