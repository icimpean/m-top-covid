...
from envs.stride_env.action_wrapper import NoChildrenNoWasteActionWrapper
...
def run_bandit(parser_args):
    ...
    env = create_stride_env(parser_args, reward=reward, reward_type=parser_args.reward_type,
                            action_wrapper=NoChildrenNoWasteActionWrapper, is_childless=True)
...
if __name__ == '__main__':
    ...
    # m = "10"
    # args = parser.parse_args([
    #     "../envs/stride_env/config/conf_0/config.xml", f"../../../Data/debug/test_{post}_childless2/",
    #     "--episodes", "3", "--episode_duration", "120", "--reward", "inf", "--reward_type", "norm",
